...
from .runners import (
    patch_dlc_runner_builders as patch_dlc_runner_builders,
    reset_inference_runner_queue as reset_inference_runner_queue,
)
...
def _collect_results(
    results_queue: Any, video_paths: list[Path], exits: tuple[WorkerExit, ...] = (), *, interrupted: bool = False
